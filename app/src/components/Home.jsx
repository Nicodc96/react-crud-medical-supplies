    ...
    return (
        <>
            ...
            <section id="main-cards-home">
                <h2 className="text-center pt-4 fs-2 pb-4 fw-semibold fst-italic">Ejemplos de equipos médicos</h2>
                <div id="containerCardsHome" className="container fluid d-flex gap-5 justify-content-center">
                    <article className="card">
                        ...
                        <div className="card-body bg-gray"> 
                            ...
                            <p className="card-text fw-semibold text-green text-center mt-2">Cardiología</p>
                        </div>
                    </article>
                    <article className="card">
                        <div className="card-img-container">
                        ...
                        <div className="card-body bg-gray">
                            ...
                            <p className="card-text fw-semibold text-green text-center mt-2">Cirugía</p>
                        </div>
                    </article>
                    <article className="card">
                        <div className="card-img-container">
                        ...
                        <div className="card-body bg-gray">
                            ...
                            <p className="card-text fw-semibold text-green text-center mt-2">Cuidados Intensivos</p>
                        </div>
                    </article>
                </div>
